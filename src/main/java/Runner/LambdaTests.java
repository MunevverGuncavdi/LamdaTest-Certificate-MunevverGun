...
public class LambdaTests {
    ...
    public void test3() throws Exception {
        try {
            ...
            driver.findElement(By.id("name")).sendKeys("munevver");
            driver.findElement(By.id("inputEmail4")).sendKeys("munevveroguz1@gmail.com");
            driver.findElement(By.xpath("//*[@type='password']")).sendKeys("munevver4556");
            driver.findElement(By.id("company")).sendKeys("munevver");
            driver.findElement(By.id("websitename")).sendKeys("munevver.com");
            Select country = new Select(driver.findElement(By.name("country")));
            country.selectByVisibleText("United States");

            driver.findElement(By.id("inputCity")).sendKeys("London");
            driver.findElement(By.id("inputAddress1")).sendKeys("high street");
            driver.findElement(By.id("inputAddress2")).sendKeys("wembley");
